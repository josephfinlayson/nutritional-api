'use strict';
var express = require('express'), router = express.Router(), apiConnect = require('../lib/apiConnect'), grocerySearch = require('../lib/grocerySearch'), cors = require('cors'), mongoose = require('mongoose'), Barcode = mongoose.model('Barcode'), Promise = require('bluebird'), now = require('performance-now');
        ...
        .then(function (data) {
            ...
            apiConnect(req.params.barcode)
                ...
                .catch(function (err) {
                    ...
                    returnError(err, {tescoHandshake: tescoHandshake, tescoCall: tescoCall});
                })
        })
});
